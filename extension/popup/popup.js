document.addEventListener('DOMContentLoaded', function () {
    ...
    chrome.storage.local.get(
        ...
        (item) => {
            ...
            fetchHadith(hadithElement, explanationElement, item.preferredHadithLang, item.preferredHadithFetchMode);
        }
    );
});
...
function fetchHadith(hadithElement,explanationElement, hadithLang, hadithFetchMode) {
    fetch('https://dailyislamichadith.com/api/fetch-hadith?fetch-mode=' + hadithFetchMode + '&lang=' + hadithLang)
        ...
        .catch(error => {
            if (hadithLang === 'en') {
                ...
                hadithElement.textContent = 'حدث خطأ ما. يرجى المحاولة مرة أخرى في وقت لاحق.';
                explanationElement.textContent = 'حدث خطأ ما. يرجى المحاولة مرة أخرى في وقت لاحق.';
            }
